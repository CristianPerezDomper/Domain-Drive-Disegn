...
public class CustomersController : ControllerBase
{
    ...
    [SwaggerOperation(
    Summary = "Actualiza a un cliente en función a su ID",
    Description = "Retorna un objeto generico con el resultado de la operación")]
    ...
    Description = "Retorna un objeto generico con el resultado de la operación")]
    [SwaggerResponse(200, "Cliente registrado", typeof(Response<CustomerDto>))]
    ...
    [SwaggerOperation(
        ...
        Description = "Retorna un objeto generico con el resultado de la operación")]
    [SwaggerResponse(200, "Cliente registrado", typeof(Response<IEnumerable<CustomerDto>>))]
